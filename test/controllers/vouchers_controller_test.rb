...
class VouchersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voucher" do
    assert_difference('Voucher.count') do
      post vouchers_url, params: { voucher: { name: @voucher.name, notes: @voucher.notes, price: @voucher.price } }
    end
  ...
  test "should update voucher" do
    patch voucher_url(@voucher), params: { voucher: { name: @voucher.name, notes: @voucher.notes, price: @voucher.price } }
